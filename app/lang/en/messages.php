...
In social media people don’t show who they are. Unmask is the first and only space where you can unmask anyone and show their real face to the world! Use our innovative and effective technology in an effort for social justice.",
	...
	"crePerFrmLblAdvertencia" => "IT’S MANDATORY TO GIVE REAL INFORMATION OF THE PERSON IN THIS PROFILE. THAT WAY WE AVOID REPEAT PROFILES OF THE SAME PERSON AND ALSO, YOU ALLOW OTHER USERS TO FIND THE SAME PROFILE YOU PREVIOUSLY CREATED SO EVERYONE CAN POST CONFESSIONS ABOUT THE SAME PERSON. PROFILES WITH FAKE INFORMATION WILL BE DELETED JUST LIKE THE ACCOUNT THAT CREATED IT. IT’S STRICTLY PROHIBIITED TO CREATE PROFILES OF FICTION CHARACTERS, AND THEY WILL BE DELETED TOO. IT’S ALSO PROHIBITED TO POST FAKE LINKS TO FACEBOOK, TWITTER, INSTRAGRAM OR VKONTACT OR LINKS THAT DON’T BELONG TO THE REAL PERSON ON THE PROFILE.",
	
	"crePerTltImgFoto" => "We recommend you post a profile with photo of the person you’d like to report. This way you will allow other users to identify this person when they see it, also, we recommend you post single photos, legible and with uncovered face (no objects, sunglasses, make up, etc.) It’s strictly forbidden to create profiles with fake pictures or pictures that don’t belong to the person of the profile. Every profile with fake pictures will be deleted, just as the account that created it.",
	"crePerTltTexto" => "Before you post a new profile, use our search engine and find out if the person you’d like to report already has a profile. If the profile doesn’t exist, you can create it by writing the names and last name without abbreviations. If you don’t know the names or last name, we encourage you to investigate and find out. Don’t post fake personal details because the profile won’t appear when people search for it and they won’t be able to see it.",
